...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header text-white" style="background-color: #643691;">${article.boardNum }번게시물
					내용</div>
				<div class="card-body">
					...
					<div class="form-group">
						<label>제목</label> <input type="text" class="form-control" name='title' value="${article.title }"
							readonly>
					</div>
...
<script>
	...
	$(document).ready(function () {
		...
		$('#list-btn').click(function () {
			...
			location.href =
				'/board/list?page=${p.page }&countPerPage=${p.countPerPage }&keyword=${p.keyword}&condition=${p.condition}';
		});
